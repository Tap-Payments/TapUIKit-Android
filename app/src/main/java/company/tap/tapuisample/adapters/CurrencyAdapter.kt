...
//            holder.itemView.setBackgroundResource(R.drawable.border_currency)
            ...
            if (ThemeManager.currentTheme.isNotEmpty() && ThemeManager.currentTheme.contains("dark")) {
                holder.itemView.setBackgroundResource(company.tap.tapuisample.R.drawable.border_currency_black)
            }else{
                holder.itemView.setBackgroundResource(company.tap.tapuisample.R.drawable.border_currency)
            }
...
//                Color.parseColor(ThemeManager.getValue("horizontalList.chips.currencyChip.selected.shadow.color"))
            ...
            if (ThemeManager.currentTheme.isNotEmpty() && ThemeManager.currentTheme.contains("dark")) {
                holder.itemView.setBackgroundResource(company.tap.tapuisample.R.drawable.border_unclick_black)
            }else{
