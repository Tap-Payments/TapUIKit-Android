...
class NFCFragment : Fragment() {
    ...
    private fun initView(view: View) {
       ...
       // aboutNFC = customNFC.aboutNFC.findViewById(R.id.about_nfc)
        ...
        customNFC.aboutNFC.text = "Near-field communication is a set of communication protocols for communication between two electronic devices over a distance of 4 cm or less."
    }
